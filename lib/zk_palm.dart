...
class ZkPalm {
  static const MethodChannel _channel = const MethodChannel('zkpalm');

  static const EventChannel statusChangeStream =
  EventChannel('com.mamasodikov.zkpalm10/status_change');
  static const EventChannel imageStream =
  EventChannel('com.mamasodikov.zkpalm10/palm_image');
  ...
  static Future<bool?> verify({String? palm1, String? palm2}) async {
    return _channel.invokeMethod(
        'verify', <String, String?>{'palm1': palm1, 'palm2': palm2});
  }

  static Future<bool?> registerPalm({String? userId}) async {
    final bool? success = await _channel
        .invokeMethod('register', <String, String?>{'id': userId});
    return success;
  }

  static Future<bool?> clearPalmDatabase() async {
    return await _channel.invokeMethod('clear');
  }

  static Future<bool?> clearAndLoadDatabase({Map<String, String>? vUserList}) async {
    return await _channel.invokeMethod('clearAndLoad', <String, Map<String, String>? >{'palms': vUserList});
  }
